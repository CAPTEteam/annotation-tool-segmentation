<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet" /><!-- Latest compiled and minified JavaScript --><script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
...
<div class="container">
<h1>Draw a box around each spike</h1>

<div class="jumbotron">
<p>Draw a rectangle using your mouse over each wheat spike (ears). See below examples:</p>
<img height="250" src="http://www.hiphen-iot.com/static/data/web_images/cnn_dataset/examples/no_1.png" /> <img height="250" src="http://www.hiphen-iot.com/static/data/web_images/cnn_dataset/examples/ok_1.png" /> <img height="250" src="http://www.hiphen-iot.com/static/data/web_images/cnn_dataset/examples/ok_2.png" /><br />
&nbsp;
<ul>
	<li>Don&#39;t forget <b>hidden spike !</b></li>
	<li>don&#39;t label a group of spikes : <b>1 spike &rArr; 1 bounding box</b></li>
</ul>
&nbsp;
...
<br />
&nbsp;
<p id="button_paragraph"><input id="annotation_data" name="annotation_data" type="hidden" /> <input class="btn btn-danger" id="reset_button" type="reset" /></p>
</div>
</div>
...
$(document).ready(function() {
  ...
  var annotator = new BBoxAnnotator({
    ...
    labels: ["spike"], // Label of the object.
